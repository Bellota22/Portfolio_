...
function NavBar() {
  return (
    <div className='fixed top-0 left-0 right-0 h-[40px] bg-transparent backdrop-filter backdrop-blur-md z-50 border-b border-bg-header flex justify-between lg:h-[64px] px-4  '>
